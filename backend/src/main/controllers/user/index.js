...
const makeHttpErrorResponse = require("../factories/makeHttpErrorResponse")
...
const changeUsernameController = new ChangeUsernameController(changeUsernameUsecase, makeHttpResponse, makeHttpErrorResponse)
